...
from csv_handler import append_and_deduplicate
import os
...
append_and_deduplicate(os.path.join("util", "data", "player_stats_merged.csv"))
...
append_and_deduplicate(os.path.join("util", "data", "feature_eng_stats.csv"))
